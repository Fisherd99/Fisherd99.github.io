...
^{\text{第一项}\boldsymbol R_t\leftrightarrow \boldsymbol R_t^{\prime}+\boldsymbol R_s}_{\text{第二项}\boldsymbol R_s\leftrightarrow \boldsymbol R_s^{\prime}+\boldsymbol R_t} &=\sum_{\mu\in S}\boxed{\sum_{\boldsymbol R_{t}^{\prime}}C_{s(0),t(\boldsymbol R_{t}^{\prime})}^{\mu(0)}e^{i\boldsymbol k_1 \cdot \boldsymbol R_{t}^{\prime}}}\frac{1}{N_{k}}\sum_{\boldsymbol R_s \boldsymbol k^{\prime}}P_{\mu}^{\boldsymbol k^{\prime}}(\boldsymbol r)\mathrm{e}^{i(\boldsymbol k_1 - \boldsymbol k_2-\boldsymbol k^{\prime})\cdot \boldsymbol R_{s}}+\sum_{\mu\in T}\boxed{\sum_{\boldsymbol R_{s}^{\prime}}C_{t(0),s(\boldsymbol R_{s}^{\prime})}^{\mu(0)}e^{-i\boldsymbol k_2 \cdot\boldsymbol R_{s}^{\prime}}}\frac{1}{N_{k}}\sum_{\boldsymbol R_t \boldsymbol k^{\prime}}P_{\mu}^{\boldsymbol k^{\prime}}(r)\mathrm{e}^{i(\boldsymbol k_1-\boldsymbol k_2 - \boldsymbol k^{\prime})\cdot \boldsymbol R_{t}} \\
&=\left[\sum_{\mu\in S}C_{s,t}^{\mu}(\boldsymbol k_1)+\sum_{\mu\in T}C_{t,s}^{\mu}(-\boldsymbol k_2) \right]P_{\mu}^{\boldsymbol k_1-\boldsymbol k_2}(r)
\end{aligned} \tag{1}$$
其中定义了C的傅里叶变换
...
=&\frac{1}{N_k}\sum_{\mu\nu}\sum_{stuv} c_{ua}^{k_{1}*}c_{si}^{k_{1}}\left[\sum_{S\in \mu}C_{s,u}^{\mu}(-\mathbf{k}_{1})+\sum_{U\in \mu} C_{u,s}^{\mu}(\mathbf{k}_{1})\right] V_{\mu\nu}(\mathbf{0})\left[\sum_{T\in \nu}C_{t,v}^{\mu}(\mathbf{k}_{2})+\sum_{V\in \nu}C_{v,t}^{\mu}(-\mathbf{k}_{2})\right]c_{tj}^{k_{2}*}c_{vb}^{k_{2}}
\end{aligned}$$
